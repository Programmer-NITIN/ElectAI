...
[![Tests](https://img.shields.io/badge/Tests-447_Passing-brightgreen?logo=jest&logoColor=white)](TESTING.md)
...
- [Testing Strategy (447 Tests)](#-testing-strategy-447-tests)
...
## 🧪 Testing Strategy (447 Tests)

> Full details in [TESTING.md](TESTING.md)

```bash
npm test              # Run all 447 tests across 24 suites
...
└── src/
    ...
    └── __tests__/               # 447 tests across 24 suites
