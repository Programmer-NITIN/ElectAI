...
export const form6DataSchema = z
  .object({
...
export const constituencyPhaseSchema = z
  .object({
    id: z.string(),
    title: z.string(),
...
export const constituencyRoadmapSchema = z
  .object({
    title: z.string(),
    description: z.string(),
...
export const evmSimulatorOutputSchema = z
  .object({
    title: z.string(),
    description: z.string(),
...
export const factCardOutputSchema = z
  .object({
    title: z.string(),
    summary: z.string(),
...
export const checklistOutputSchema = z
  .object({
    title: z.string(),
    description: z.string(),
...
export const form6WizardOutputSchema = z
  .object({
    state: z.string(),
    eligible: z.boolean(),
    summary: z.string(),
