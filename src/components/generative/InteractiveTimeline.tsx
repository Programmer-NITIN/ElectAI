          ...
          <div key={step.id} className="flex gap-4" role="listitem">
            ...
            <div className="flex flex-col items-center">
              <div
                className={cn(
                  ...
                  step.status === "current" &&
                    "bg-indigo-600/20 border-indigo-500 text-indigo-400 animate-pulse-glow",
              ...
              {i < steps.length - 1 && (
                <div
                  className={cn(
                    "w-0.5 h-12 my-1",
                    step.status === "completed" ? "bg-green-500/50" : "bg-slate-700",
                  )}
                />
              )}
            </div>
            ...
            <div className="pb-6">
              <h4
                className={cn(
                  "font-medium text-sm",
                  step.status === "current" ? "text-indigo-400" : "text-white",
                )}
              >
                {step.title}
              </h4>
              ...
              {step.date && (
                <span className="text-xs text-gray-500 mt-1 inline-block">📅 {step.date}</span>
              )}
